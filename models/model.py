"""
	BiLSTM-CRF model with pre-trained word embeddings for sequence tagging task - Open Relation Extraction
	PyTorch version
"""
...
"""
Create helper functions for further application
"""
def argmax(vec):
...
"""
BiLSTM-CRF model for sequence tagging: word embeddings + predicate POS embedding
"""
...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, weights_matrix, embedding_dim, hidden_dim, pos_embedding_dim, START_TAG, STOP_TAG):
        ...
        self.word_embeds.weight.data.copy_(torch.from_numpy(weights_matrix))
        self.lstm = nn.LSTM(embedding_dim, hidden_dim // 2, num_layers = 1, bidirectional = True)
        
        # Map the output of LSTM into tag space
    ...
    def _forward_alg(self, feats):
        ...
        for feat in feats:
            ...
            for next_tag in range(self.tagset_size):
                ...
                # The ith entry of next_tag_var is the value for the edge (i->next_tag) before the log-sum-exp
    ...
    def _viterbi_decode(self, feats):
        ...
        for feat in feats:
            ...
            # Add in the emission scores, assign forward_var to the set of viterbi variables just computed
